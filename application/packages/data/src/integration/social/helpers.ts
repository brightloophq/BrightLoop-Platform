/* =============================================================================
 * Social connectors — operation helpers (F4.7). PURE (except output).
 *
 ...
 * key survives into a result. Shared by all four social bindings.
 * ========================================================================== */
...
/** Coerce a metric-ish scalar (number|numeric string) to a finite number, or undefined. */
export function scalarNum(v: unknown): number | undefined {
