/* =============================================================================
 * Finance connectors — operation helpers (F4.6). PURE (except output).
 *
 ...
 * key survives into a result. Shared by both finance bindings.
 * ========================================================================== */
...
/** Coerce a money-ish scalar (number|numeric string) to a finite number, or undefined. */
