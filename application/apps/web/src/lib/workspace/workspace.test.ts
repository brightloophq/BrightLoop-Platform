...
describe("workspace navigation", () => {
  it("exposes the primary product sections", () => {
    expect(WORKSPACE_NAV.map((n) => n.key)).toEqual(["dashboard", "projects", "ai-team", "copilot", "automations", "runtime", "deployments", "runtimes", "executions", "reports", "approvals", "activity", "settings"]);
  });
