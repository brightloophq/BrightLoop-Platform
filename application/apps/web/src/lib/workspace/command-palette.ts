...
export const WORKSPACE_COMMANDS: readonly WorkspaceCommand[] = [
  ...
  { id: "go-runtime-center", label: "Open Runtime Center", hint: "Ops mission control", group: "Navigate", href: "/workspace/runtime", keywords: ["runtime", "center", "ops", "mission control", "health", "deploy"] },
  ...
  { id: "go-settings", label: "Open Settings", hint: "Workspace settings", group: "Navigate", href: "/workspace/settings", keywords: ["settings", "preferences"] },
  { id: "go-notifications", label: "Open Notifications", hint: "What needs attention", group: "Navigate", href: "/workspace/notifications", keywords: ["notifications", "alerts", "inbox", "attention"] },
  { id: "go-profile", label: "View Profile", hint: "Your identity + access", group: "Navigate", href: "/workspace/profile", keywords: ["profile", "account", "me", "role"] },
  { id: "go-admin", label: "Open Administration", hint: "Org, access, AI team", group: "Navigate", href: "/workspace/admin", keywords: ["admin", "administration", "organization", "team", "manage"] },
