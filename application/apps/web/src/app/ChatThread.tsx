...
import { sendMessage, markConversationRead } from "./conversation-actions";
 ...
 */
export function ChatThread({ conversationId, meId, initialMessages, people, readByOther }: ChatThreadProps) {
